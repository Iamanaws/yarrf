...
var (
	youtubeFrame = `<iframe src="https://www.youtube-nocookie.com/embed/%s" width="560" height="315" frameborder="0" allowfullscreen></iframe>`
	vimeoFrame   = `<iframe src="https://player.vimeo.com/video/%s?dnt=1" width="640" height="360" frameborder="0" allowfullscreen></iframe>`
